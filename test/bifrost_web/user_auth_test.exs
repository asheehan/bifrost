defmodule BifrostWeb.UserAuthTest do
  use BifrostWeb.ConnCase, async: true

  alias Bifrost.Accounts
  alias Bifrost.Accounts.Scope
  alias BifrostWeb.UserAuth

  import Bifrost.AccountsFixtures

  @remember_me_cookie "_bifrost_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BifrostWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
