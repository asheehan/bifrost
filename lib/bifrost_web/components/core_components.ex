defmodule BifrostWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BifrostWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BifrostWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BifrostWeb.Gettext, "errors", msg, opts)
    end
  end
